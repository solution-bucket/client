...
/* harmony import */ var _context_auth__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(40730);
...
function Posts() {
    ...
    const { 0: auth , 1: setAuth  } = (0,react__WEBPACK_IMPORTED_MODULE_5__.useContext)(_context_auth__WEBPACK_IMPORTED_MODULE_10__/* .AuthContext */ .V);
    ...
    const fetchPosts = async ()=>{
        try {
            const { data  } = await axios__WEBPACK_IMPORTED_MODULE_6___default().get("/posts-for-admin");
            setPost((prev)=>({
                    ...prev,
                    posts: data
                }));
...
var __webpack_exports__ = __webpack_require__.X(0, [676,1664,730,5330,1982,9897], () => (__webpack_exec__(96024)));
